...
def main():
    ...
    data_array = np.load("08_R001C001_pure.npy")[:224496] #224496
    label_array = np.load("08_R001C001_label_pure.npy")[:224496] #
    val_data = np.load("08_R002C034_pure.npy")[:10000]
    val_label = np.load("08_R002C034_label_pure.npy")[:10000]
    ...
    for epoch in range(500):
        ...
        with torch.no_grad():
            ...
            print('VAL:Epoch [%d] loss = %.3f, total acc: %.3f %%' % (epoch + 1, loss_show.avg, accurate_show.avg))
