...
def train():
    ...
    test_files_fixed = glob.glob(os.path.join(args.test_dir_fixed, '*.tif'))
    test_files_moving = glob.glob(os.path.join(args.test_dir_moving, '*.tif'))
    DS = Dataset(files_fixed=test_files_fixed,files_moving=test_files_moving)
