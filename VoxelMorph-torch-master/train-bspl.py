...
def train():
    ...
    UNet = U_Network(2, nf_enc, nf_dec,img_height=1024,img_width=1024).to(device) # len(vol_size )是数据维度。
    STN = SpatialTransformer((1024,1024)).to(device)
    ...
    for i in range(1000):
        ...
        # for i in range(1, args.n_iter + 1):
            ...
            m2f,flow,flow_m2f = UNet(input_moving, input_fixed)
        ...
        # Save images
        m_name = "Result/base_bspl_round/"+str(i) + "-m.tif"
        m2f_name = "Result/base_bspl_round/"+str(i) + "-w.tif"
        f_name = "Result/base_bspl_round/"+str(i) + "-f.tif"
