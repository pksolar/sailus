...
def main():
    ...
    val_data = np.load("data/08_R002C034_conv.npy")
    val_label = np.load("data/08_R002C034_label_conv.npy")
    ...
    # 定义损失函数和优化器
    best_model = torch.load("savedir_pth/acc99.278.pth.tar")['state_dict']
    #best_model = torch.load("bestpth/08C002val/acc99.276.pth.tar")['state_dict']
