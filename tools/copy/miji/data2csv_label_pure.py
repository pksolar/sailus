...
for name in total_30path:
    ...
    np.save("flatten/val/pure/{}_{}_pure.npy".format(machinename,runname), dataArray)
    np.save("flatten/val/pure/{}_{}_label_pure.npy".format(machinename,runname), label_array)
