...
def main():
    ...
    test_dir_total =  glob.glob(
        r"E:\data\deep\image2base\single_element\img\30_R001C001_*.npy") #total_dir = glob.glob(r"E:\code\python_PK\callbase\datasets\{}\Res\Lane01\deepLearnData\*\intensity_norm\*_A.npy".format(dataset_name))
    ...
    fastQ.writeFq('fastq/{:.3f}-fast21_{}.fq'.format(accurate_show.avg, timestr), listacgt, 'ROO1C001')
