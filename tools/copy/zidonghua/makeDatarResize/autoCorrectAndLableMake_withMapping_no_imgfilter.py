...
rootdir = r"E:\data\resize_test\17_R1C78_resize_ori" # 下一级目录是FOV
fovlsit = ["R001C001"]
save_root_dir = r"E:\data\testAuto"
for fov in fovlsit:
    print(fov)
    machineName = fov
    rootdir = fr"{rootdir}\\"
    resdir = rootdir+"res_deep_No_imageFilter"
    ori_mappingdir = resdir

    # 步骤1，运行baseCall，为了生成用来mapping的文件fastq以及生成配准后的图像。
    step1_command = rf'E:\software\DeepLearningDataMake\SalusCall_No_imageFilter.exe {rootdir} {resdir} 1 100 1 1 -m'
