...
if __name__=="__main__":
    #fastq文件所在文件夹
    ori_mappingdir = r"E:\code\python_PK\tools\ChangeBasePromoteMapping\mappingTool\fastq\bingji95.09_very_sensitive_local"

    #fastq名字
    fastq_name =  "Lane01_fastq_bing" #

    #mapping的模式：local: --sensitive-local,--very-sensitive-local，--very-fast-local,--fast-local，end2end：--very-fast，--very-sensitive，--fast，
    mappingmode = "--very-sensitive-local"
