...
machinename = '17h'
fov='R001C001'
#E:\data\resize_test\1  7_resize_ori\res_deep_intent\Lane01
source_name = "17_resize_ori"
totalpath_A  = glob.glob(r"E:\data\resize_test\{}\res_deep_intent\Lane01\deepLearnData\*\intensity_norm\{}_A.npy".format(source_name,fov))
msk_path = r"E:\data\resize_test\{}\res_deep_intent\Lane01\deepLearnData\{}_mask.npy".format(source_name,fov)
msk = np.load(msk_path).astype(int)
msk[msk==-1]=0 #pure
totalReadsNum = np.sum(msk) # only msk ==1:
...
np.save("E:\data\liangdujuzhen\img/{}_{}_pure.npy".format(machinename,fov), dataArray)
np.save("E:\data\liangdujuzhen\label/{}_{}_pure.npy".format(machinename,fov), label_array)
