...
np.save(r"E:\data\liangdujuzhen\update_bingji\img/{}_{}_pure.npy".format(machinename,fov), dataArray)
np.save(r"E:\data\liangdujuzhen\update_bingji\label/{}_{}_pure.npy".format(machinename,fov), label_array)
