...
machinename = '08h'
fov='R001C001'
#原始的intensity norm在的位置：
totalpath_A  = glob.glob(r"E:\data\resize_test\08_resize_ori\res_deep_intent\Lane01\deepLearnData\*\intensity_norm\{}_A.npy".format(fov))
#新的label所在的位置:
resultDir = r"E:\data\fastqResult\bingji95.09_very_sensitive_local"
#新的msk所在位置：
msk_path = os.path.join(resultDir,"deepLearnData","R001C001_mask.npy")
...
np.save(r"E:\data\liangdujuzhen\update_bingji\img/{}_{}_withNoMap.npy".format(machinename,fov), dataArray)
np.save(r"E:\data\liangdujuzhen\update_bingji/label/{}_{}_withNoMap.npy".format(machinename,fov), label_array)
