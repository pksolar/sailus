...
parser.add_argument('--save_path', type=str, default='save_file/base_baseline',
...
parser.add_argument('--pre', type=str, default=False,#'save_file/base_baseline/model_best.pth',
...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--best_pred', type=int, default=100,
                    help='best pred')
