...
'''change your path'''
root = r'E:\code\python_PK\image2base\FIDTM-master-base\data\noname'
...
for img_path in img_paths:
    ...
    '''for visualization'''
    savepath = img_path.replace('images', 'gt_show').replace('jpg', 'jpg')
    print(savepath)
    # cv2.imshow("fidt_map1",fidt_map1)
    # cv2.waitKey(0)
    cv2.imwrite("ddd.jpg", fidt_map1)
