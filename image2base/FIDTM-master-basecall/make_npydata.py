...
shanghai_root = r'E:\code\python_PK\image2base\FIDTM-master-base\data\noname'
...
try:
    ...
    shanghaiAtrain_path = shanghai_root + '/train_data/images/'
    shanghaiAtest_path = shanghai_root + '/test_data/images/'
    ...
    train_list.sort()
    np.save('./npydata/base_train.npy', train_list)
    ...
    test_list.sort()
    np.save('./npydata/base_test.npy', test_list)
