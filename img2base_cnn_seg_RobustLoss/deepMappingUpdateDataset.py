...
def deepUpdateData(rootdir,fastq_name,save_root_dir):
    ...
    step3_command = rf'python E:\CrosstalkTool\generData_PengKuanKuan_deep.py  {sfile_path}  {sfile_path} {ori_mappingdir}\Lane01\samResult {resdir}\Lane01\deepLearnData'
...
if __name__ == "__main__":
    ...
    file_name = "144h_R001C001_96.705_0509195919"
    save_root_dir = "E:\data/testAuto"
