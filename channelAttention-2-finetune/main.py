...
def main():
    ...
    train_img_files = [f for f in all_img_files if "upate"  in f and "pure" in f]
    ...
    if continueTrain == True:
        best_model = torch.load("savedir_pth/acc99.605_epoch29982_loss0.0134.pth.tar")['state_dict']
