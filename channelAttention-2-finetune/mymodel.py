...
class DNA_Sequencer_Atten_Deep(nn.Module):
    def __init__(self):
        super(DNA_Sequencer_Atten_Deep, self).__init__()
        coresize = 3
        paddingsize = 1
        self.conv1 = nn.Conv2d(4, 32, (coresize, coresize), padding=paddingsize) #3个cycle,每个cycle 4张图
        self.conv2 = nn.Conv2d(32, 64, (coresize, coresize), padding=paddingsize)
        self.conv3 = nn.Conv2d(64, 128, (coresize, coresize), padding=paddingsize)
        self.conv4 = nn.Conv2d(128, 256, (coresize, coresize), padding=paddingsize)
        self.conv5 = nn.Conv2d(256, 128, (coresize, coresize), padding=paddingsize)
        self.conv6 = nn.Conv2d(128, 64, (coresize, coresize), padding=paddingsize)
        self.conv7 = nn.Conv2d(64, 32, (coresize, coresize), padding=paddingsize)
        self.conv8 = nn.Conv2d(32, 16, (coresize, coresize), padding=paddingsize) #一次性预测3个label
        self.conv9 = nn.Conv2d(16, 4, (coresize, coresize), padding=paddingsize)  # 一次性预测3个label
        self.relu = nn.ReLU()
