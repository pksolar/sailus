...
def kernelmy(gray,blockSize,max_value = None):#从512-256-128，最低亮度是512：
...
def unevenLightCompensate(gray, blockSizelist):
    ...
    for blockSize in blockSizelist:
        gray,max_value = kernelmy(gray,blockSize,max_value)
    return gray
...
if __name__ == '__main__':
    ...
    for k in range(11):
        if k < 10:
            ...
            str_k = str(k)
        file_name1 = r"image_ori4\Lane01\Cyc0{}".format(str_k)
