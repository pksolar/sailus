...
# paths_A = glob.glob(r"\\192.168.7.121\e\NGS\OutFile\202210111619_Pro021_B_1011_cleave30s_se100_ecoli__\Image\Lane01\*\R001C001_A.tif")
# paths_A = glob.glob(r"\\192.168.7.121\e\NGS\OutFile\202210111619_Pro021_B_1011_cleave30s_se100_ecoli__\Image\Lane01\*\R001C001_A.tif")
#paths_A = glob.glob(r"E:\code\python_PK\callbase\datasets\highDens\Image\Lane01\*\R001C001_A.tif")
paths_A = glob.glob(r"\\192.168.7.121\e\NGS\OutFile\202210111619_Pro021_B_1011_cleave30s_se100_ecoli__\Image\Lane01\*\R001C001_A.tif")
for pathA in paths_A:
    ...
    imgnameA = pathA.split("\\")[-1]#.replace("R002C034","R001C001")
    print(cycname," ",imgnameA)
    #path_save= "E:\code\python_PK\callbase\datasets\highDens_08_6_nogauss\Image\Lane01\{}".format(cycname)
    path_save = "E:\code\python_PK\callbase\datasets\highDens_22_5.3_nogauss\Image\Lane01\{}".format(cycname)
