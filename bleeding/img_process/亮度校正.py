...
def unevenLightCompensate(gray, blockSizelist):
    ...
    for blockSize in blockSizelist:
        ...
        dst = (gray2/255.0) ** blockImage2*255.0 #这个尺度的变换结果
        #dst_c = dst.copy()
...
paths_x = glob.glob(r"E:\data\highDensity\dense0.6\R001C001\Lane01\*\R001C001_A.tif")
save_dir = "44h_unevenLight_x0.9"
