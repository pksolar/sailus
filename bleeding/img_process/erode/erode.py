...
paths_A = glob.glob(r"E:\code\python_PK\bleeding\img_process\4channel_process\08_reg_add_bac\Lane01\*\R001C001_A.tif")
import threading
...
for pathA in paths_A:
    ...
    path_save = r"E:\code\python_PK\bleeding\img_process\erode\reg_kernel_3\Lane01\{}".format(cycname)
