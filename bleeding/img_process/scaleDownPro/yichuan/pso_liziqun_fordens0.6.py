...
def evaluate_kernel(params):
    ...
    for pathA in paths_A:
        ...
        path_save = r"E:\code\python_PK\bleeding\img_process\scaleDownPro\yichuan_pso_dense0.6\image\Lane01\{}".format(cycname)
    ...
    rootdir = r"E:\code\python_PK\bleeding\img_process\scaleDownPro\yichuan_pso_dense0.6\image\\"
    resdir = "res"
