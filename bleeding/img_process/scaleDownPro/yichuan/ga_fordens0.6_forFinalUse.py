...
import threading
import autoQ30mapping_finalHighDense as  autoQ30mapping
...
def evaluate_kernel(params):
    ...
    with open('kernel_mapping_pso_dense0.6_final.txt', 'a') as f:
        np.savetxt(f, kernel)
    #对图像采用多线程卷积操作：
    threads = []
    ...
    for pathA in paths_A:
        ...
        path_save = r"E:\code\python_PK\bleeding\img_process\scaleDownPro\yichuan_pso_dense0.6_final\image\Lane01\{}".format(cycname)
    ...
    rootdir = r"E:\code\python_PK\bleeding\img_process\scaleDownPro\yichuan_pso_dense0.6_final\image\\"
    resdir = "res"
...
with open('kernel_mapping_pso_dense0.6.txt', 'a') as f:
