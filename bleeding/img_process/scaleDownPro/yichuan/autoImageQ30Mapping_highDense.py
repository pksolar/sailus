...
# 保存结果的文件夹名
dirname = "yichuan_dange_08_highDense_1.0_92.43"
...
def evaluate_kernel(rootdir,resdir,cycNum):
    ...
    :return:
    """
    params = [0, 0,1] #-0.06165437730
    kernel = np.array([[params[0], params[1], params[0]],
                       [params[1], params[2], params[1]],
                       [params[0], params[1], params[0]]])
    s = "0.000000000000000000e+00 -6.165437730737638455e-02 0.000000000000000000e+00 -6.165437730737638455e-02 1.000000000000000000e+00 -6.165437730737638455e-02 0.000000000000000000e+00 -6.165437730737638455e-02 0.000000000000000000e+00"
