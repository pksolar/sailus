...
device = "cuda"
# 读取图像的路径
paths_x = glob.glob("E:\code\python_PK\callbase\datasets\highDens\Image\Lane01\*\R001C001_G.tif") #必须出去未map上的
#导入label数据
label_y = glob.glob(r"E:\code\python_PK\bleeding\gtvalue\label_vector\*_G_label_vector.npy")
#导入未map的点的id，去除未map
...
for i in range(1000):
    ...
    for x,y,name_num in train_loader:
        ...
        subloc = np.loadtxt( r"E:\code\python_PK\callbase\datasets\highDens\result_outcorrd\Lane01\sfile\R001C001_{}_G_otherCycChanCoord.txt".format(cycle_num), usecols=(2, 3)).T
