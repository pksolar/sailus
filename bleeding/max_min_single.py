...
for pathA in paths_A:
    ...
    path_save = r"E:\data\resize_testImage\08_max_minus\Lane01\{}".format(cycname)
    ...
    max_minus(pathA,path_save,"_A")
    max_minus(pathA.replace("R001C001_A", "R001C001_C"), path_save, "_C")
    max_minus(pathA.replace("R001C001_A", "R001C001_G"), path_save, "_G")
    max_minus(pathA.replace("R001C001_A", "R001C001_T"), path_save,"_T")


    # # create threads for each channel
    # threadA = threading.Thread(target=max_minus, args=(pathA,path_save,"_A"))
    # threadC = threading.Thread(target=max_minus, args=(pathA.replace("R001C001_A","R001C001_C"), path_save,"_C"))
    # threadG = threading.Thread(target=max_minus, args=(pathA.replace("R001C001_A", "R001C001_G"), path_save,"_G"))
    # threadT = threading.Thread(target=max_minus, args=(pathA.replace("R001C001_A", "R001C001_T"), path_save,"_T"))
