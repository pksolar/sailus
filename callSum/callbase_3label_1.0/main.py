...
def main():
    ...
    total_dir = glob.glob(r"E:\code\python_PK\callbase\datasets\{}\Res\Lane01\deepLearnData\*\intensity_norm\R001*_A.npy".format(dataset_name))

    train_dir = total_dir[0:int(rate*len(total_dir))] #
    val_dir = glob.glob(r"E:\code\python_PK\callbase\datasets\{}\Res\Lane01\deepLearnData\*\intensity_norm\R002*_A.npy".format(dataset_name_val))[:20]
