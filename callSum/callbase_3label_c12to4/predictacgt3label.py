...
def main():
    ...
    best_model = torch.load("savedir_pth/acc99.193880.pth.tar")['state_dict']
        ...
        for r in range(row):
            ...
            for c in range(col):
                ...
                for inputs, labels, msk in test_loader:  #
                    ...
                    outputs = model(inputs) #inputs/outputs  :b 12 h w
    ...
    fastQ.writeFq('fastq/fast21_2_{}.fq'.format(timestr), listacgt2, 'ROO1C001')
