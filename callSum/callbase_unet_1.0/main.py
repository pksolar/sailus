...
from data.datasets import Dataset_epoch_norm , Dataset_epoch_test,Dataset_epoch12,Dataset_epoch12_val
from callNet.model1 import  Max,UNet
"""
    出现的问题：
...
def main():
    ...
    total_dir = glob.glob(r"E:\code\python_PK\callbase\datasets\30\Res\Lane01\deepLearnData\*\intensity_norm\*_A.npy")

    train_dir = total_dir[0:int(rate*len(total_dir))] #

    train_dataset = Dataset_epoch12(train_dir)
    ...
    model = UNet(input_channels,N_CLASS).to(device)
