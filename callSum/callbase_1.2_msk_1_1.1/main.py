...
from data.datasets import Dataset_epoch_norm , Dataset_epoch_test,Dataset_epoch,Dataset_epoch12_val
...
def main():
    ...
    total_dir1 = glob.glob(r"E:\code\python_PK\callbase\datasets\{}\Res\Lane01\deepLearnData\*\intensity_norm\*_A.npy".format(dataset_name1))
    total_dir2 = glob.glob(r"E:\code\python_PK\callbase\datasets\{}\Res\Lane01\deepLearnData\*\intensity_norm\*_A.npy".format(dataset_name2))
    ...
    train_loader = data.DataLoader(train_dataset,batch_size=BATCHSIZE,num_workers = 4,shuffle=True)
    ...
    val_dataset = Dataset_epoch12_val(val_dir)
    ...
    for epoch in range(500):
        ...
        with torch.no_grad():
            for inputs,labels,msk in val_loader: #
                ...
                c = (preds == label_) #里面有多少true和false，  5 h w
