...
for idx,i in enumerate(msk_flatten):
 if i == 1 :
    for name in name_list:
        img_norm = np.load(r"E:\code\python_PK\callbase\datasets\08\Res\Lane01\deepLearnData\Cyc052\intensity_norm\R001C001_{}.npy".format(name))
        ...
        img_v = np.load(r"E:\code\python_PK\callbase\datasets\08\Res\Lane01\deepLearnData\Cyc052\intensity\R001C001_{}.npy".format(name)).ravel()[idx]
    ...
    label = np.load(r"E:\code\python_PK\callbase\datasets\08\Res\Lane01\deepLearnData\Cyc052\label\R001C001_label.npy").ravel()[idx]
    print("label:",label)
