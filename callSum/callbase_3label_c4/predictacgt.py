...
def main():
    ...
    best_model = torch.load("savedir_pth/acc99.206371.pth.tar")['state_dict']
    ...
    fastQ.writeFq('fastq/fast21_c4_{}.fq'.format(timestr), listacgt, 'ROO1C001')
