...
from datasets_read_img_resize_filter_3label_bingji import Dataset_3cycle,Dataset_3cycle_val
...
def main():
    ...
    BATCHSIZE = 4
    best_acc = 0
    save_dir = 'nested_pth_bingji_noFinetune/'
