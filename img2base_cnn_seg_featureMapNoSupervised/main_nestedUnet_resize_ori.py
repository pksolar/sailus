...
from datasets_read_img_onlyCELoss_resize_ori import Dataset_3cycle,Dataset_3cycle_val
        ...
        if epoch % 2 == 0:
            ...
            with torch.no_grad():
                for inputs, labels, msk in val_loader:  #
                    ...
                    number = torch.sum(msk)
                    loss_val = criterion(outputs * msk, labels * msk,number)
