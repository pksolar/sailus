...
from utils import  *
from model_unet import UNet,ExponentialLoss
import random
...
def main():
    ...
    train_loader = data.DataLoader(train_dataset, batch_size=BATCHSIZE, num_workers=11, shuffle=True,pin_memory=True)
