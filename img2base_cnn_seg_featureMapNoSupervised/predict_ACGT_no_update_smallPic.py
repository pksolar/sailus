...
import fastQ
import time
from datasets_read_img_onlyCELoss import Dataset_3cycle_test
...
def main():
    ...
    test_dir_total =  glob.glob(
        rf"C:\deepdata\image_update\img\{fov}_*_A_img.tif") #total_dir = glob.glob(r"E:\code\python_PK\callbase\datasets\{}\Res\Lane01\deepLearnData\*\intensity_norm\*_A.npy".format(dataset_name))
