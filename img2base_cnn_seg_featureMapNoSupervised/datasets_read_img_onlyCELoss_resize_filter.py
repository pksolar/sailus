...
class Dataset_3cycle(data.Dataset):
    ...
    def __getitem__(self, step):
        ...
        label_path = path.replace("img", "label").replace("_"+basetype,".npy")  # basetype: A.tif
...
class Dataset_3cycle_test_center_side(data.Dataset):
    def __init__(self, names, norm=False):
        # 输入只读带有A的
        super(Dataset_3cycle_test_center_side, self).__init__()
        self.names = names
        self.norm = norm
        # 所有的数据都读到了index_pair里
        self.index_pair = names
...
class Dataset_3cycle_test_crop(data.Dataset):
    def __init__(self, names, norm=False):
        # 输入只读带有A的
        super(Dataset_3cycle_test_crop, self).__init__()
        self.names = names
        self.norm = norm
        # 所有的数据都读到了index_pair里
        self.index_pair = names
...
class Dataset_3cycle_test_Bigcrop(data.Dataset):
    def __init__(self, names, norm=False):
        # 输入只读带有A的
        super(Dataset_3cycle_test_Bigcrop, self).__init__()
        self.names = names
        self.norm = norm
        # 所有的数据都读到了index_pair里
        self.index_pair = names
...
class Dataset_3cycle_test_Bigcrop_3label(data.Dataset):
    def __init__(self, names, norm=False):
        # 输入只读带有A的
        super(Dataset_3cycle_test_Bigcrop_3label, self).__init__()
        self.names = names
        self.norm = norm
        # 所有的数据都读到了index_pair里
        self.index_pair = names
