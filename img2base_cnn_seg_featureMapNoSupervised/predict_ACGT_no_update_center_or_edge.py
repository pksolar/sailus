...
import fastQ
import time
from datasets_read_img_onlyCELoss_resize_filter import Dataset_3cycle_test_center_side
...
def main():
    ...
    test_dir = test_dir_total[-11:-1]
    test_dataset = Dataset_3cycle_test_center_side(test_dir)
    ...
    with torch.no_grad():
        ...
        for inputs, labels, msk in test_loader:  #注意此处的msk 是否包含mapping上的
            ...
            label_ = torch.max(labels, 1)[1]   # label的值也是0,1,2,3，
