...
from datasets_read_img_resize_filter_AdaptMask import Dataset_3cycle, Dataset_3cycle_val
...
def main():
    ...
    for epoch in range(5000):
        ...
        for inputs, labels, msk, name in train_loader:
            ...
            loss = criterion(outputs * msk, labels * msk) * 65536 /  number
            """
        ...
        if epoch % 2 == 0:
            ...
            with torch.no_grad():
                for inputs, labels, msk in val_loader:  #
                    ...
                    number = torch.sum(msk)
                    loss_val = criterion(outputs * msk, labels * msk) * 65536 / number
