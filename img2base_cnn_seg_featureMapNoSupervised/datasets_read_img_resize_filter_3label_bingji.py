...
class Dataset_3cycle(data.Dataset):
    ...
    def __getitem__(self, step):
        ...
        label_middle_path = path.replace("img", "label").replace("_" + basetype, ".npy").replace("08h","08hvslvf")  # basetype: A.tif
        ...
        label_front_path = img_front_path.replace("img", "label").replace("_" + basetype, ".npy").replace("08h","08hvslvf")
        ...
        label_behind_path = img_behind_path.replace("img", "label").replace("_" + basetype, ".npy").replace("08h","08hvslvf")
        ...
        msk_path = path.replace(os.path.basename(path), f"{machine}_{fov}_msk.npy").replace("img", "msk").replace("08h","08hvslvf")
