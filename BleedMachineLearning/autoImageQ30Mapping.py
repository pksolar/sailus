...
#原始图像所在文件夹的A图：
paths_A = glob.glob(r"E:\data\resize_test\08_resize1.25\Lane01\*\R001C001_A.tif")
# 保存结果的文件夹名
dirname = "yichuan_dange_08x1.25_89.86_100"
...
def evaluate_kernel(rootdir,resdir,cycNum):
    ...
    :return:
    """
    params = [-0.1,-0.275,2.525]
    kernel = np.array([[params[0], params[1], params[0]],
                       [params[1], params[2], params[1]],
                       [params[0], params[1], params[0]]])
    s = "-6.299212598425196763e-02 -2.755905511811023167e-01 -6.299212598425196763e-02 -2.755905511811023167e-01 2.526418786692759433e+00 -2.755905511811023167e-01 -6.299212598425196763e-02 -2.755905511811023167e-01 -6.299212598425196763e-02"
