...
def main():
    ...
    # val_data = np.load("E:\code\python_PK\datanpy/08_R002C034_conv_notpure.npy")
    # val_label = np.load("E:\code\python_PK\datanpy/08_R002C034_conv_notpure_label.npy")
    #
    # val_data = np.load("E:\code\python_PK\datanpy/21_R001C001_conv_notpure.npy")
    # val_label = np.load("E:\code\python_PK\datanpy/21_R001C001_label_conv_notpure.npy")
    ...
    best_model = torch.load("savedir_pth/acc99.294.pth.tar")['state_dict']
    ...
    fastQ.writeFq('fastq/{:.3f}-fast08_train_noconv_{}.fq'.format(accurate_show.avg,timestr), predict_list, 'ROO1C001')
