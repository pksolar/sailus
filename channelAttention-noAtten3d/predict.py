...
def main():
    ...
    best_model = torch.load("savedir_pth/acc99.285.pth.tar")['state_dict']
    ...
    fastQ.writeFq('fastq/{:.3f}-fast21_conv_{}.fq'.format(accurate_show.avg,timestr), predict_list, 'ROO1C001')
