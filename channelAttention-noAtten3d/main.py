...
import numpy as np
from mymodel import DNA_Sequencer_Atten3D
...
def main():
    ...
    data_array = np.load("E:\code\python_PK\datanpy/08_R001C001_conv.npy")[:224496]  # 224496
    label_array = np.load("E:\code\python_PK\datanpy/08_R001C001_label_conv.npy")[:224496]  #
    val_data = np.load("E:\code\python_PK\datanpy/08_R002C034_conv_pure.npy")[:10000]
    val_label = np.load("E:\code\python_PK\datanpy/08_R002C034_label_conv_pure.npy")[:10000]
    ...
    model = DNA_Sequencer_Atten3D().to(device)
    # best_model = torch.load("savedir_pth/acc99.283.pth.tar")['state_dict']
    ...
    for epoch in range(10000):
        ...
        for inputs, labels in train_loader:
            ...
            labels = labels.to(device) .squeeze(1) # b,c,h,w
