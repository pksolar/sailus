...
def norm(arr):# 对每个通道各自做归一化。
    ...
    return arr
saveRootPath = r"E:\data\deepData\test\\44.1h\\"
...
for dir_name in dirs:
    ...
    for i in range(1,101):
        ...
        np.save(saveRootPath+"img\\"+machine_name+"\\"+rf"{i:03d}"+"\\"+rf"001.npy",image_middle.astype(np.float32))
        np.save(saveRootPath + "label\\" + machine_name + "\\"+rf"{i:03d}"+"\\"+ rf"001.npy", label_middle.astype(np.uint8))
